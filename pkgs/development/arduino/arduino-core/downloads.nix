...
// optionalAttrs (system == "x86_64-linux") {
  ...
  "build/linux/avrdude-6.3.0-arduino5-x86_64-pc-linux-gnu.tar.bz2" = fetchurl {
...
// optionalAttrs (system == "i686-linux") {
  ...
  "build/linux/avrdude-6.0.3-arduino5-i686-pc-linux-gnu.tar.bz2" = fetchurl {
...
// optionalAttrs (system == "x86_64-darwin") {
  ...
  "build/linux/avrdude-6.0.3-arduino5-i386-apple-darwin11.tar.bz2" = fetchurl {
...
// optionalAttrs (system == "armv6l-linux") {
  ...
  "build/linux/avrdude-6.0.3-arduino5-armhf-pc-linux-gnu.tar.bz2" = fetchurl {
